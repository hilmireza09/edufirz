...
const Footer = () => {
  return (
    <footer className="relative py-16 px-4 mt-24 bg-gradient-to-r from-purple-900 to-purple-800">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <Button size="icon" variant="outline" className="bg-white/10 border-white/20 hover:bg-white/20 hover-lift">
