      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {courses.map((course, index) => (
            <Card
              key={course.id}
              className="glass-card border-0 overflow-hidden hover-lift group animate-fade-in-up"
            ...
            >
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 glass-card px-3 py-1 rounded-full text-sm font-medium">
                  {course.level}
                </div>
              </div>
