-- Fix: Use jsonb_array_length instead of array_length for checking correct_answers
...
BEGIN
  ...
  LOOP
    ...
    IF v_question.correct_answers IS NULL OR cardinality(v_question.correct_answers) = 0 THEN
