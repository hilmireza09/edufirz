-- Fix submit_quiz_attempt scoring logic for fill_in_blank
-- Previously it relied on 'points' inside the options JSON which doesn't exist
-- Now it calculates score based on proportion of correct blanks
