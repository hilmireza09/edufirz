-- Fix checkbox scoring to fallback to correct_answer field when correct_answers is empty
...
BEGIN
  ...
  LOOP
    ...
    IF v_question.correct_answers IS NULL OR array_length(v_question.correct_answers, 1) IS NULL THEN
