-- Fix: Finalize checkbox scoring logic with strict validation and data error handling
        ...
        WHEN 'checkbox', 'multiple_answers' THEN
          ...
          ELSE
             ...
             IF jsonb_typeof(v_user_answer) = 'array' THEN
                 ...
                 -- Determine if fully correct (allow for floating point comparison safety)
                 IF v_question_score >= (v_points - 0.001) THEN
                    v_is_correct := TRUE;
